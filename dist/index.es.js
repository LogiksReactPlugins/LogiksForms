import he, { useState as Te, useRef as Ct, useEffect as ve, useMemo as an } from "react";
...
function tl() {
  return Kr || (Kr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function u(A, S, N, j, z, L, X, I) {
      ...
      if (V.call(S, "key")) {
        R = t(A);
        var O = Object.keys(S).filter(function(Y) {
          return Y !== "key";
        });
        j = 0 < O.length ? "{key: someKey, " + O.join(": ..., ") + ": ...}" : "{key: someKey}", $e[R + j] || (O = 0 < O.length ? "{" + O.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (R = null, N !== void 0 && (n(N), R = "" + N), i(S) && (n(S.key), R = "" + S.key), "key" in S) {
        N = {};
        for (var D in S)
          D !== "key" && (N[D] = S[D]);
      } else N = S;
    ...
    var K, fe = {}, Oe = f["react-stack-bottom-frame"].bind(
      f,
      o
    )(), ze = J(r(o)), $e = {};
...
function wl({
  ...
  const [a, c] = Te(!1), [u, d] = Te(
    i ?? t.options ?? {}
  ), f = Ct(null), [h, p] = Te(""), [g, y] = Te(0), b = Ct(null), x = Ct(null), [v, k] = Te(!1), E = Ct(h), M = t.disabled === !0;
  ve(() => {
    E.current = h;
  }, [h]);
  const $ = (N) => {
  ...
  ve(() => {
    let N = !0;
    return (async () => {
      let z = t.valueKey ?? "value", L = t.labelKey ?? "title", X = t?.options;
      ...
      if (t.type === "dataMethod") {
        ...
        if (O)
          try {
            const D = await O(), Y = Array.isArray(D?.data?.data) ? D.data.data : Array.isArray(D.data.results) ? D.data.results : Array.isArray(D?.data) ? D.data : D;
            if (typeof Y == "object" && !Array.isArray(Y)) {
              const Ut = Object.values(Y);
              if (Ut.length && typeof Ut[0] == "string") {
                d(Y);
                return;
              }
            }
            const Ee = Array.isArray(Y) ? Y.map(ut) : [], pe = ct(z, L, Ee, t.groupKey);
            N && d(pe);
          } catch (D) {
      ...
      if (I.type === "api" && I.endpoint)
        try {
          ...
          const Y = Array.isArray(D) ? D.map(ut) : [], Ee = ct(z, L, Y, t.groupKey);
          N && d(Ee);
        } catch (R) {
      ...
      if (t.table || t.type === "dataSelector" || t.queryid) {
        ...
        try {
          ...
          const O = await Xt(r, R, t?.queryid, void 0, o), D = Array.isArray(O?.data?.data) ? O.data.data : Array.isArray(O.data.results) ? O.data.results : Array.isArray(O?.data) ? O.data : O;
          if (typeof D == "object" && !Array.isArray(D)) {
            const pe = Object.values(D);
            if (pe.length && typeof pe[0] == "string") {
              d(D);
...
`, H = `
  ...
  `, V = an(
    ...
    return V.find(([, j]) => j.trim().toLowerCase() === N);
  }, [t.type, h, V]), J = V.length, K = an(() => t.search || !h ? V : V.filter(
    ...
    if (x.current?.open === !0 || v === !0)
      if (N.key === "ArrowDown")
        ...
        const [z] = K[g] || [];
        if (z) {
          let L = j ? z : [...e.values[t.name], z];
          e.setFieldValue(t.name, L), Nt(L, t, o);
        }
  ...
  ve(() => {
    ...
    (async () => {
      try {
        ...
        for (const I of L) {
          ...
          let D = t.valueKey ?? "value", Y = t.labelKey ?? "title";
    ...
    const N = pl(t.columns ?? ""), j = new AbortController(), z = setTimeout(async () => {
      try {
        ...
        const { data: O } = await Xt(r, L, t?.queryid, void 0, o, X), D = Array.isArray(O?.data?.data) ? O.data.data : Array.isArray(O?.data) ? O.data : O, Y = Array.isArray(D) ? D.map(ut) : [], Ee = ct(
          I,
          R,
          Y,
          t.groupKey
  ...
  const Oe = async (N) => {
    ...
    try {
      const j = await to(r, N), z = t.multiple ? j.map((L) => L.path) : j[0]?.path;
      e.setFieldValue(
        F,
        z
      ), Nt(z, t, o);
    } catch (j) {
      console.error("File upload failed", j), e.setFieldError(F, "File upload failed");
    }
  }, ze = async (N, j, z) => {
    const L = j[N];
    if (!L) return;
    ...
    try {
      await Promise.resolve(X(z));
    } catch (I) {
      console.error(`Method "${String(L)}" failed`, I);
    }
  }, $e = (N) => {
    if (M) return;
    const j = N.target.value;
    p(j), y(0), j.trim() ? k(!0) : (k(!1), e.setFieldValue(F, ""));
  }, A = (N) => {
                ...
                children: [
                  /* @__PURE__ */ m.jsx(
                    "input",
                    {
                      ...
                      onChange: (M) => {
                        const $ = M.target.checked ? [...o, v] : o?.filter((F) => F !== v);
...
function lo(t, e, n, r) {
  ...
  if (s == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      return Qe(o, co(t, i, l, e, r));
    }
  else return Qe(o, gn(t, e, r));
}
function ao(t, e) {
...
function co(t, e, n, r, s) {
  ...
  return Mt(null, t, s, l), o && i && e.index(s) == n.index(s) ? (ao(o, i), Xe(Qe(o, co(t, e, n, r, s + 1)), l)) : (o && Xe(Qe(o, gn(t, e, s + 1)), l), Mt(e, n, s, l), i && Xe(Qe(i, gn(n, r, s + 1)), l)), Mt(r, null, s, l), new C(l);
}
function gn(t, e, n) {
  let r = [];
  if (Mt(null, t, n, r), t.depth > n) {
    let s = sr(t, e, n + 1);
    Xe(Qe(s, gn(t, e, n + 1)), r);
  }
...
class Me {
  ...
  */
  hasMarkup(e, n, r) {
    return this.type == e && pn(this.attrs, n || e.defaultAttrs || Ml) && U.sameSet(this.marks, r || U.none);
  }
  /**
...
let es = class bo {
  ...
  */
  create(e = null, n, r) {
    ...
    return new Me(this, this.computeAttrs(e), C.from(n), U.setFrom(r));
  }
  /**
  ...
  */
  createChecked(e = null, n, r) {
    return n = C.from(n), this.checkContent(n), new Me(this, this.computeAttrs(e), n, U.setFrom(r));
  }
  /**
...
class Mn {
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new U(this, mo(this.attrs, e));
  }
  /**
  @internal
  */
...
class Wl {
  ...
  */
  text(e, n) {
    ...
    return new bn(r, r.defaultAttrs, e, U.setFrom(n));
  }
  /**
...
class rs {
  constructor(e, n, r) {
    ...
    s ? o = new Zt(s.type, s.attrs, U.none, !0, n.topMatch || s.type.contentMatch, i) : r ? o = new Zt(null, null, U.none, !0, null, i) : o = new Zt(e.schema.topNodeType, null, U.none, !0, null, i), this.nodes = [o], this.find = n.findPositions, this.needsBlock = !1;
  }
  get top() {
...
class B extends W {
  ...
  */
  static between(e, n, r) {
    ...
    return e.parent.inlineContent || (s == 0 ? e = n : (e = (W.findFrom(e, -r, !0) || W.findFrom(e, r, !0)).$anchor, e.pos < n.pos != s < 0 && (e = n))), new B(e, n);
  }
}
W.jsonID("text", B);
class On {
...
const Bo = (t, e, n) => {
  ...
  if (Uo(t, s, e, -1))
    return !0;
  if (r.parent.content.size == 0 && (yt(o, "end") || P.isSelectable(o)))
    for (let i = r.depth; ; i--) {
      let l = In(t.doc, r.before(i), r.after(i), T.empty);
      if (l && l.slice.size < l.to - l.from) {
        if (e) {
          let a = t.tr.step(l);
          a.setSelection(yt(o, "end") ? W.findFrom(a.doc.resolve(a.mapping.map(s.pos, -1)), -1) : P.create(a.doc, s.pos - o.nodeSize)), e(a.scrollIntoView());
        }
        return !0;
      }
...
const Vo = (t, e, n) => {
  ...
  if (Uo(t, s, e, 1))
    return !0;
  if (r.parent.content.size == 0 && (yt(o, "start") || P.isSelectable(o))) {
    let i = In(t.doc, r.before(), r.after(), T.empty);
    if (i && i.slice.size < i.to - i.from) {
      if (e) {
        let l = t.tr.step(i);
        l.setSelection(yt(o, "start") ? W.findFrom(l.doc.resolve(l.mapping.map(s.pos)), 1) : P.create(l.doc, l.mapping.map(s.pos))), e(l.scrollIntoView());
      }
      return !0;
    }
  }
...
function Uo(t, e, n, r) {
  ...
  let u = o.type.spec.isolating || r > 0 && a ? null : W.findFrom(e, 1), d = u && u.$from.blockRange(u.$to), f = d && xt(d);
  if (f != null && f >= e.depth)
...
function Ha(t, e = null) {
  ...
  if (Xo(n)) {
    for (a = i; s && !s.node; )
      s = s.parent;
    let d = s.node;
    if (s && d.isAtom && P.isSelectable(d) && s.parent && !(d.isInline && La(n.focusNode, n.focusOffset, s.dom))) {
      let f = s.posBefore;
...
function _a(t) {
  ...
  r ? e.collapse(n.parentNode, lt(n) + 1) : e.collapse(n, 0), !r && !t.state.selection.visible && _t && ei <= 11 && (n.disabled = !0, n.disabled = !1);
}
function Ka(t, e) {
  if (e instanceof P) {
  ...
  if (r instanceof B)
    if (n.indexOf("s") > -1) {
      ...
      if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
        let s = dr(t.state, e);
        return s && s instanceof P ? Le(t, s) : !1;
      } else if (!(xe && n.indexOf("m") > -1)) {
        let s = r.$head, o = s.textOffset ? null : e < 0 ? s.nodeBefore : s.nodeAfter, i;
        if (!o || o.isText)
          return !1;
        let l = e < 0 ? s.pos - o.nodeSize : s.pos;
        return o.isAtom || (i = t.docView.descAt(l)) && !i.contentDOM ? P.isSelectable(o) ? Le(t, new P(e < 0 ? t.state.doc.resolve(s.pos - o.nodeSize) : s)) : jr ? Le(t, new B(t.state.doc.resolve(e < 0 ? l : l + o.nodeSize))) : !1 : !1;
      }
    } else return !1;
  else {
...
function Cs(t, e, n) {
  let r = t.state.selection;
  if (r instanceof B && !r.empty || n.indexOf("s") > -1 || xe && n.indexOf("m") > -1)
    return !1;
  let { $from: s, $to: o } = r;
  ...
  if (!s.parent.inlineContent) {
    let i = e < 0 ? s : o, l = r instanceof ye ? W.near(i, e) : W.findFrom(i, e);
    return l ? Le(t, l) : !1;
  }
  return !1;
}
...
be.keypress = (t, e) => {
  let n = e;
  if (pi(t, n) || !n.charCode || n.ctrlKey && !n.altKey || xe && n.metaKey)
    return;
...
function lc(t, e) {
  ...
  return r && r.isAtom && P.isSelectable(r) ? (mt(t, new P(n)), !0) : !1;
}
function ac(t, e) {
  if (e == -1)
    return !1;
  ...
  return s != null ? (mt(t, P.create(t.state.doc, s)), !0) : !1;
}
...
class hc {
  ...
  up(e) {
    ...
    // works around that.
    Be && !this.view.state.selection.visible && Math.min(Math.abs(n.pos - this.view.state.selection.from), Math.abs(n.pos - this.view.state.selection.to)) <= 2) ? (mt(this.view, W.near(this.view.state.doc.resolve(n.pos))), e.preventDefault()) : _e(this.view, "pointer");
  }
  move(e) {
...
class Q {
  ...
  */
  static create(e, n) {
    return n.length ? Cn(n, e, 0, et) : de;
  }
  /**
  ...
  */
  mapInner(e, n, r, s, o) {
    ...
    return this.children.length ? Cc(this.children, i || [], e, n, r, s, o) : i ? new Q(i.sort(tt), ht) : de;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (u = xi(n, l, c)) {
        for (s || (s = this.children.slice()); o < s.length && s[o] < a; )
          o += 3;
        s[o] == a ? s[o + 2] = s[o + 2].addInner(l, u, c + 1) : s.splice(o, 0, a, a + l.nodeSize, Cn(u, l, c + 1, et)), o += 3;
      }
    });
    let i = bi(o ? wi(n) : n, -r);
    for (let l = 0; l < i.length; l++)
...
class Ge {
  ...
  forChild(e, n) {
    ...
    for (let s = 0; s < this.members.length; s++) {
      ...
      o != de && (o instanceof Ge ? r = r.concat(o.members) : r.push(o));
    }
    return Ge.from(r);
  }
  eq(e) {
  ...
  static from(e) {
    switch (e.length) {
      ...
      case 1:
        return e[0];
      default:
        return new Ge(e.every((n) => n instanceof Q) ? e : e.reduce((n, r) => n.concat(r instanceof Q ? r : r.members), []));
    }
  }
  forEachSet(e) {
    for (let n = 0; n < this.members.length; n++)
...
function Xc(t, e = null) {
  ...
  return e === "all" ? B.create(t, Ye(0, s, o), Ye(t.content.size, s, o)) : B.create(t, Ye(e, s, o), Ye(e, s, o));
}
function js() {
...
function Ft(t, e, n) {
  ...
  if (s) {
    if (n.errorOnInvalidContent) {
      ...
      if (n.slice ? Ze.fromSchema(a).parseSlice(tn(t), n.parseOptions) : Ze.fromSchema(a).parse(tn(t), n.parseOptions), n.errorOnInvalidContent && i)
...
var Lu = (t, e = {}) => ({ tr: n, state: r, dispatch: s }) => {
  ...
  if (n) {
    const { doc: r } = e, s = Ye(t, 0, r.content.size), o = P.create(r, s);
    e.setSelection(o);
  }
  return !0;
  ...
  if (n) {
    const { doc: r } = e, { from: s, to: o } = typeof t == "number" ? { from: t, to: t } : t, i = B.atStart(r).from, l = B.atEnd(r).to, a = Ye(s, i, l), c = Ye(o, i, l), u = B.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
...
var Ju = ({ keepMarks: t = !0 } = {}) => ({ tr: e, state: n, dispatch: r, editor: s }) => {
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (s) {
      ...
      n.replace(M, a.after(-v), new T(b, 4 - x, 0));
      let $ = -1;
      n.doc.nodesBetween(M, n.doc.content.size, (F, _) => {
        if ($ > -1)
          return !1;
        F.isTextblock && F.content.size === 0 && ($ = _ + 1);
      }), $ > -1 && n.setSelection(B.near(n.doc.resolve($))), n.scrollIntoView();
    }
    return !0;
  }
  ...
  if (s) {
    ...
    if (n.split(a.pos, 2, y).scrollIntoView(), !k || !s)
      return !0;
    const E = k.filter((M) => v.includes(M.type.name));
    n.ensureMarks(E);
  }
  return !0;
}, Qn = (t, e) => {
  ...
  if (!v)
    return !1;
  const E = Br((M) => Os(M.type.name, d))(g);
  ...
  return !n || !k || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Qn(o, h)).command(() => Zn(o, h)).run() : a().command(() => {
    const M = u().wrapInList(h, r), $ = k.filter((F) => f.includes(F.type.name));
  ...
  onUpdate({ transaction: t, appendedTransactions: e }) {
    ...
    const o = () => {
      ...
      u.steps.forEach((h, p) => {
        var g, y;
        if (h instanceof Se) {
          const b = f.slice(p).map(h.from, -1), x = f.slice(p).map(h.to), v = f.invert().map(b, -1), k = f.invert().map(x), E = (g = u.doc.nodeAt(b - 1)) == null ? void 0 : g.marks.some(($) => $.eq(h.mark)), M = (y = u.doc.nodeAt(x)) == null ? void 0 : y.marks.some(($) => $.eq(h.mark));
          this.editor.emit("delete", {
            type: "mark",
            mark: h.mark,
            from: h.from,
...
}), $i = new ke("focusEvents"), md = Ne.create({
  name: "focusEvents",
  addProseMirrorPlugins() {
    const { editor: t } = this;
    return [
  ...
  return {
    ...
    markdownTokenizer: {
      ...
      tokenize(d, f, h) {
        ...
        const E = b.length;
        let M = "";
        const $ = /^:::([\w-]*)(\s.*)?/gm, F = d.slice(E);
        for ($.lastIndex = 0; ; ) {
          const _ = $.exec(F);
          if (_ === null)
            break;
          const H = _.index, w = _[1];
          if (!((p = _[2]) != null && p.endsWith(":::"))) {
            if (w)
              ...
              const V = F.slice(0, H);
              M = V.trim();
              const ie = d.slice(0, E + H + _[0].length);
              let J = [];
              if (M)
                if (l === "block")
                  for (J = h.blockTokens(V), J.forEach((K) => {
...
`;
    ...
    for (u += 1; u < l.length; ) {
      const E = l[u];
      if (E.trim() === "") {
        const $ = l.slice(u + 1).findIndex((H) => H.trim() !== "");
        if ($ === -1)
          break;
...
`, u += 1;
    ...
    const v = b.slice(1);
    if (v.length > 0) {
      const E = v.map((M) => M.slice(g + d)).join(`
`);
    ...
    for (let p = 0; ; p++) {
      ...
      for (let v = 0; v < b; v++) {
        ...
        for (let E = 0; E < y; E++) {
          ...
          if (M) {
            const $ = (k + E) % e * 2, F = i[$];
            F == null || F != M && i[$ + 1] == 1 ? (i[$] = M, i[$ + 1] = 1) : F == M && i[$ + 1]++;
          }
        }
      }
      s += y, u += g.nodeSize;
...
var _d = class Bi {
  ...
  resolve(e) {
    ...
    return n.parent.type.spec.tableRole == "row" && r.parent.type.spec.tableRole == "row" && n.index() < n.parent.childCount && r.index() < r.parent.childCount && Vr(n, r) ? new q(n, r) : W.near(r, 1);
  }
};
function Kd(t) {
...
function Ie(t) {
  const e = t.selection, n = Dn(t), r = n.node(-1), s = n.start(-1), o = G.get(r);
  return {
...
function sn(t, e) {
  return (n, r, s) => {
    if (!s) return !1;
    const o = n.selection;
    if (o instanceof q) return fn(n, r, W.near(o.$headCell, e));
    if (t != "horiz" && !o.empty) return !1;
    const i = _i(s, t, e);
    if (i == null) return !1;
    if (t == "horiz") return fn(n, r, W.near(n.doc.resolve(o.head + e), e));
    {
      const l = n.doc.resolve(i), a = Pi(l, t, e);
      let c;
      return a ? c = W.near(a, 1) : e < 0 ? c = W.near(n.doc.resolve(l.before(-1)), -1) : c = W.near(n.doc.resolve(l.after(-1)), 1), fn(n, r, c);
    }
  };
}
function on(t, e) {
  return (n, r, s) => {
    ...
    return l ? fn(n, r, new q(i.$anchorCell, l)) : !1;
  };
}
function xf(t, e) {
...
function wf(t, e, n) {
  ...
  if (s instanceof q) {
    ...
    return Hs(t.state, t.dispatch, i, G.get(o.node(-1)).findCell(o.pos - i), r), !0;
  } else return !1;
}
function vf(t, e) {
  var n;
  ...
  else if (e.shiftKey && r && (s = st(t.state.selection.$anchor)) != null && ((n = er(t, e)) === null || n === void 0 ? void 0 : n.pos) != s.pos)
...
function Jt({
  ...
  switch (t.type) {
    ...
    case "autosuggest":
    case "autocomplete": {
      const S = e.values[w] ?? "", N = $ !== "" ? $ : nr(_, S) ?? String(S ?? "");
      return /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
        ...
        ie && !H && /* @__PURE__ */ m.jsx(
          "div",
          {
            ...
            children: V.length > 0 && Oe ? V.map(([j, z], L) => /* @__PURE__ */ m.jsx(
              "div",
              {
                id: `${w}-${j}`,
                "data-index": L,
                className: `px-3 py-2 cursor-pointer text-sm
                  ${F === L ? "bg-gray-100" : "hover:bg-gray-100"}`,
                onMouseDown: () => b(j),
                children: z
              },
              j
    ...
    case "dataMethod": {
      ...
      return /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ m.jsxs(
          "details",
          {
            className: `relative w-full ${H ? "opacity-70" : ""}`,
            onToggle: f,
            ref: K,
            onKeyDown: (S) => {
              H || d(S, !0);
            ...
            children: [
              /* @__PURE__ */ m.jsxs(
                "summary",
                {
                  className: `
    select-none border rounded-lg px-4 py-2.5 flex justify-between items-center
    ${H ? "bg-gray-100 border-gray-200 text-gray-500 cursor-not-allowed" : "bg-white border-gray-300 cursor-pointer"}
  `,
                  children: [
              ...
              !H && /* @__PURE__ */ m.jsxs("div", { ref: J, className: "absolute mt-1 w-full border border-gray-200 rounded-lg bg-white shadow-md z-10 max-h-60 overflow-y-auto p-2", children: [
                t.search && /* @__PURE__ */ m.jsx("div", { className: "sticky top-0 bg-white p-1", children: /* @__PURE__ */ m.jsx(
                  "input",
                  {
                    type: "text",
                ...
                V.length > 0 ? V.map(([S, N], j) => /* @__PURE__ */ m.jsx(
                  "div",
                  {
                    id: `${w}-${S}`,
                    "data-index": j,
                    ...
                    className: `px-2 py-1 hover:bg-gray-50 rounded cursor-pointer text-sm 
                        ${e.values[w] === S ? "bg-indigo-50 text-indigo-600 font-medium" : F === j ? "bg-gray-100" : "hover:bg-gray-50"}`,
                    children: N
                  },
                  S
                )) : /* @__PURE__ */ m.jsx("div", { className: "px-2 py-1 text-gray-400 text-sm", children: "No results" })
      ...
      return /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ m.jsxs(
            "select",
            {
              className: `${k} ${E} appearance-none ${H ? "" : "cursor-pointer"} pr-12`,
              onFocus: () => g(!0),
              name: w,
              id: w,
              value: e.values[w],
              ...
              children: [
                ...
                Ur(_) && Object.entries(_).map(([S, N]) => /* @__PURE__ */ m.jsx("optgroup", { label: S, children: Object.entries(N).map(([j, z]) => /* @__PURE__ */ m.jsx("option", { value: j, children: z }, j)) }, S))
              ]
            }
          ),
    ...
    case "checkbox": {
      ...
      return /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ m.jsx("div", { className: "flex flex-col gap-2 ml-1", children: Object.entries(_ || {}).map(([N, j]) => /* @__PURE__ */ m.jsxs(
          "label",
          {
            className: "flex items-center gap-x-2 text-sm font-medium text-gray-700 cursor-pointer",
            children: [
              /* @__PURE__ */ m.jsx(
                "input",
                {
                  ...
                  onChange: (z) => {
                    const L = z.target.checked ? [...S, N] : S.filter((X) => X !== N);
                    e.setFieldValue(w, L), x(L, t, o), c("onChange", t, `${w}-${N}`);
                  },
                  onBlur: e.handleBlur,
                  disabled: H,
                  className: `h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500
    ...
    case "tags": {
      const S = e.values[w], N = $.trim(), j = Array.isArray(_) ? _ : Object.entries(_ || {}).map(([I, R]) => ({ value: I, label: R })), z = (I) => {
        if (!H && I && !S.includes(I)) {
          let R = [...S, I];
      ...
      }, X = (I) => j.find((R) => R.value === I)?.label ?? I;
      return /* @__PURE__ */ m.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ m.jsxs("label", { className: M, children: [
          t.label,
          t.required && /* @__PURE__ */ m.jsx("span", { className: "text-red-500 ml-1", children: "*" })
        ...
        /* @__PURE__ */ m.jsxs(
          "div",
          {
            ...
            `,
            onClick: () => !H && document.getElementById(`${w}-input`)?.focus(),
            children: [
...
function qf({
  ...
  return /* @__PURE__ */ m.jsx("div", { className: "relative z-10 max-w-full  m-4", children: /* @__PURE__ */ m.jsx("div", { className: "bg-white border border-gray-100 rounded-md animate-in fade-in duration-300", children: /* @__PURE__ */ m.jsxs("form", { onSubmit: b.handleSubmit, className: "p-4 mx-auto", children: [
    /* @__PURE__ */ m.jsxs("div", { className: "space-y-2", children: [
      ...
      d && Object.entries(d).map(([x, v], k) => /* @__PURE__ */ m.jsx(Gs, { title: x, isFirst: k === 0 && u.length === 0, children: /* @__PURE__ */ m.jsx("div", { className: "grid grid-cols-12 gap-4", children: v.map((E, M) => {
...
function Jf({
  ...
  const { common: d = [], ...f } = e, h = Object.keys(f), [p, g] = he.useState(0), [y, b] = he.useState({}), x = (w, V) => {
    ...
    return a ? Object.entries(e).forEach(([J, K]) => {
      const fe = {};
      It(K, w, fe, n, u, l?.operation), ie[J] = fe;
  ...
  }, [e, n, a, u, l?.operation]), M = h[p] ?? null, $ = a && M ? E[M] ?? {} : k, F = Tn({
    initialValues: v,
    enableReinitialize: !0,
    validationSchema: le.object().shape($),
    onSubmit: (w) => {
    ...
    if (w.preventDefault(), !a) {
      ...
      if (Object.keys(V).length > 0) {
        alert("Please fill all required fields before submitting."), F.setTouched(
          Object.keys(V).reduce((ie, J) => ({ ...ie, [J]: !0 }), {})
        );
        return;
      }
    }
  ...
  return /* @__PURE__ */ m.jsx("div", { className: " max-w-full  m-4", children: /* @__PURE__ */ m.jsxs("form", { onSubmit: _, className: "w-full mx-auto", children: [
    ...
    /* @__PURE__ */ m.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ m.jsx("div", { className: "grid grid-cols-12 gap-4", children: M && f[M]?.map((w, V) => {
          ...
          /* @__PURE__ */ m.jsxs("div", { className: `mt-8 flex ${p > 0 ? "justify-between" : "justify-end"} space-x-3`, children: [
            p > 0 && /* @__PURE__ */ m.jsx("button", { onClick: H, type: "button", className: "px-5 py-2 bg-white text-gray-700 font-semibold rounded-lg border-2 border-gray-200  shadow-sm hover:shadow-lg transform hover:scale-105 transition-all duration-300 ", children: "Previous" }),
            /* @__PURE__ */ m.jsxs("div", { className: "space-x-3", children: [
...
function Gf({
  ...
  return /* @__PURE__ */ m.jsx("div", { className: "relative z-10 max-w-full  m-4", children: /* @__PURE__ */ m.jsx("div", { className: "bg-white animate-in fade-in duration-300", children: /* @__PURE__ */ m.jsxs("form", { onSubmit: b.handleSubmit, className: "p-4 mx-auto", children: [
    /* @__PURE__ */ m.jsxs("div", { className: "space-y-2", children: [
      ...
      d && Object.entries(d).map(([x, v], k) => /* @__PURE__ */ m.jsx(Ys, { title: x, children: /* @__PURE__ */ m.jsx("div", { className: "grid grid-cols-12 gap-4", children: v.map((E, M) => {
        const $ = Vt(E.hidden) || E.type === "geolocation";
        return /* @__PURE__ */ m.jsx(
          "div",
          {
...
function nh({
  ...
  const p = async (y) => {
    ...
    if (b.type === "method") {
      ...
      if (E)
        try {
          const M = await Promise.resolve(E(v));
          if (o?.(M), e?.handleActions) {
            let $ = a?.operation === "update" ? c : M?.data?.refid;
