...
export declare function fetchDataByquery(sqlOpsUrls: Record<string, any>, query: Record<string, any> | undefined, querid: string | undefined, refid?: string | undefined, filter?: Record<string, any>): Promise<AxiosResponse<any>>;
